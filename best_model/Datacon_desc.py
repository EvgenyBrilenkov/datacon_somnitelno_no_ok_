...
# %%
df = pd.read_csv('E:\\My_projects\\data_analysis_d.csv', index_col=0) 
...
# %%
df.drop(columns=['Units', 'Uptake'], inplace=True)
...
combined_df = combined_df.loc[(combined_df['tsne_x'] < 40) & (combined_df['tsne_x'] > -40)]
